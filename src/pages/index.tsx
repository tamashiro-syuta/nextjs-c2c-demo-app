...
const HomePage: NextPage<HomePageProps> = ({
  ...
  // 商品カードカルーセルをレンダリング
  const renderProductsCardCarousel = (products: Product[]) => {
    return (
      <ProductCardCarousel>
          ...
          <Box width="100%">
            <Text as="p" color="white" variant="mediumLarge">
              ...
              <Text
                ...
                target="_blank"
                href="https://github.com/gihyo-book/ts-next-app"
                variant="mediumLarge"
                color="white"
              >
                こちら
      ...
      <Flex paddingBottom={2} justifyContent="center">
        ...
        >
          <Box marginBottom={3}>
            ...
            {renderProductsCardCarousel(clothesProducts)}
          </Box>
          <Box marginBottom={3}>
            <Text as="h2" variant="large">
              本
            </Text>
            {renderProductsCardCarousel(bookProducts)}
          </Box>
          <Box marginBottom={3}>
            <Text as="h2" variant="large">
              シューズ
            </Text>
            {renderProductsCardCarousel(shoesProducts)}
          </Box>
        </Box>
      </Flex>
    </Layout>
